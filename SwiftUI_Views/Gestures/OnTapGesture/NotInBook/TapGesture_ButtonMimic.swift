...
struct TapGesture_ButtonMimic: View {
            ...
            VStack(spacing: 20) {
                ...
                Group {
                    Text("Receive total direct deposit of at least $1,000 within the last 31 days. ")
                        ...
                        .foregroundStyle(isTouchedDown ? Color(#colorLiteral(red: 0.6941176471, green: 0.337254902, blue: 0.8745098039, alpha: 0.396621919)) : .purple)
                }
                .gesture(
